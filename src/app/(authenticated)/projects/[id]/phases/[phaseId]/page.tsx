  ...
  return (
    <div className="max-w-5xl mx-auto space-y-10 pb-20 px-4 sm:px-6 lg:px-0 text-[#0F172A] font-sans">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
        <section className="lg:col-span-2 bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-4 pt-6 border-t border-slate-100">
             {!loading && hasPermission('documents.create') && (
               <ActionButton title="Upload" trigger={<Button variant="secondary" className="h-10 w-32 cursor-pointer"><FileUp className="h-4 w-4" /> Upload</Button>}><DocumentForm projectId={id} ids={{ phase_id: phaseId, milestone_id: milestoneId }} /></ActionButton>
             )}
        ...
        {/* Milestone Stats Section - Fixed Spacing and Layout */}
        <section className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm flex flex-col justify-start overflow-hidden h-full">
            <div className="flex items-center gap-2 mb-8 shrink-0">
                ...
                <h3 className="text-xs font-bold tracking-widest uppercase text-slate-400">Milestone Stats</h3>
            </div>
            <div className="flex-1 flex flex-col justify-around min-h-[180px]">
