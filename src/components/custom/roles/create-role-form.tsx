...
export function CreateRoleForm({ onSuccess, showButton = true }: CreateRoleFormProps) {
    ...
    const {
        ...
        formState: { errors },
        reset,
    } = useForm<Omit<CreateRoleInput, "permission_ids" | "name">>()
    ...
    const onSubmit = async (data: Omit<CreateRoleInput, "permission_ids" | "name">) => {
        ...
        try {
            const roleData: CreateRoleInput = {
                ...data,
                name: data.display_name.toLowerCase().replace(/[^a-z_]/g, '_'), // Generate name from display_name
    ...
    return (
        <div className="space-y-5" id="create-role-form">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="space-y-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <div className="bg-white border rounded-lg p-4 max-h-[400px] overflow-y-auto space-y-3 shadow-sm custom-scrollbar">
                        {Object.entries(permissionsByModule).map(([module, modulePerms]) => {
                            ...
                            return (
                                <div key={module} className="space-y-2">
                                    <div className="flex items-center space-x-2 pb-2 border-b bg-gray-50 -mx-3 px-3 py-2 rounded">
                                        <Checkbox
                                            id={`module-${module}`}
                                            checked={allSelected}
